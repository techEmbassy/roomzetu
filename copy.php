                                                ...
                                                <table class="table">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th class="border-0" scope="col">Age bracket (Yrs)</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" onkeyup="change_total_paid(value)" onkeypress="return isNumber(event)" aria-label="Amount (to the nearest dollar)" placeholder="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control " placeholder="enter Reference #" id="reference-number">
                                            </div>
...
-->
                            ...
                            <div class="col-md-4">
                                <a class="btn btn-primary btn-md next hide" onclick="addReservation()">Finish</a>
                            </div>
...
<script>
    ...
    function getXtraBedsRates() {
        ...
        $.post("src/get_data.php", {
            ...
            $.each(rates_obj, function(i, rate) {
                ...
                rows += '<td id="unit_cost"   data-id="' + rate.id + '">' + rate.cost + '</td>';
    ...
    function getKidsRates() {
        ...
        $.post("src/get_data.php", {
            ...
            $.each(rates_obj, function(i, rate) {
                ...
                rows += "<td class='unit_price' >" + rate.amount + "</td>";
                rows += "<td><input  id='qty' onkeyup='calculateChildPrice(this)' class=\"form-control form-control-sm\" type=\"text\" style=\"border:2px solid #eee;\" placeholder=\"enter kids number here\">";
                rows += "</td>";
    ...
    function calclateBedTotals(context) {
        ...
        var unit_cost = parseFloat(tr.find("#unit_cost").html());
    ...
    $("#paymemt_mtd").on("change", function() {
        ...
        if (option == "Cheque" || option == "EFT" || option == "RTGS" || option == "Cash" || option == "Creditcard") {
    ...
    $("#tb-free-rooms").html("<tr><td>Please Select Check-in and Check-out dates to Load Free Rooms</td></tr>");
    ...
    function getCustomMealCart() {
        ...
        $("#custom_meal_plan_tb_0 tbody tr").each(function(i, tr) {
    ...
    function setFreeRooms(data) {
        ...
        if (rooms.length > 0) {
            ...
            $.each(rooms, function(i, room) {
                ...
                rows += "<option class=''>Custom</option>";
                rows += "</select>";;
                rows += "</div>";
                ...
                */
                ...
                rows += "</div>";
                rows += "</div>";
                rows += "<br><br><span><span class='price'>$<input class=\"silent-input border-0 room_unit_price price\" style=\"font-size:20px;\" id=\"" + room.id + "unit-price\" value='0' onkeyup='getUnitPrice(\"" + room.id + "\" )' /> </span> per night</span>";
    ...
    function addGuests(btn) {
        ...
        var ag = $("#tb-guests tbody tr").length;
    ...
    function addReservation() {
       ...
       */
        ...
        $.post("src/xhr.php", {
            ...
            //            x0popup({ // maxWidth: '450px', // maxHeight: '200px' // }, false);
    ...
    function setSelectedRooms() {
        ...
        var row = "";
        var rms = 0;
        var bubble = $(".selected-rooms-count");
        $("#tb-free-rooms tr.selected").each(function(i, tr) {
            row += "<tr>";
