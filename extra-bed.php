			...
			<div class="row">
				<div class="col-md-2 mt-2">
					...
					<div class="foot pt-4 pl-2 text-left ">									    	  
						<a class="btn btn-sm btn-secondary" data-target="#add-extra-bed" data-toggle="modal"><i class="fa fa-plus"></i> New Extra Bed</a>
					</div>
...
-->
									...
									<a class="btn btn-secondary btn-35" href="" data-target="#add-extra-bed" data-toggle="modal"><i class="fa fa-plus"></i> New Extra Bed</a>
		...
		var data = JSON.stringify({
		  ...
		  $.post("src/xhr.php", {
			  ...
			  if(parseInt(response)==1){
                ...
                alertify.success("<i class='fa fa-check-circle'></i> Extra Bed  successfully saved");
                $('#ename').val("");
                $('#ecost').val("");
...
//                alert(response)
                    if(response==="success"){
                           $("#edit-modal").modal("hide");
                            alertify.success("<i class='fa fa-check-circle'></i>Value successfully updated");
                           getExtraBed();
                    }
