...
<div class="modal animated zoomIn full-screen" tabindex="-1" role="dialog" id="preview-invoice">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="btn-group">
                    ...
                    <a type="button" class="btn btn-sm btn-outline-warning export-invoice-pdf" target="_blank">Print Invoice</a>
                </div>
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                ...
                <section class="card paper invoice-prev">
                    <?php 
                    //$preview = 1;
...
//        preview
//    })
    function previewInvoice(bookingId){
        $('.invoice-prev').html(loaderBig);
        $("#preview-invoice").modal('show');
      $.post("includes/invoice.php", {preview:true,booking_id:bookingId}, function(data){
          $('.invoice-prev').html(data);          
          $('.export-invoice-pdf').prop('href', "invoice/"+bookingId);
      })
    }
