...
<script>
    ...
    function updateStartDate(t) {
        ...
        if (yyyy != yyyy_) {
            alertify.error("<i class='zmdi zmdi-check-circle'></i> You can only select dates in the current year");
            getSeasons();
        } else {
    ...
    function setHighSeason(seasons) {
        ...
        table_head_high += "<th class=\"text-center\"><a href=\"javascript:void(0);\" style=\"font-size:25px;\" id=\"addPeriodForHigh\" title=\"Add More Seasons\"><span class=\"zmdi zmdi-plus\"></span></a></th></tr>";
    ...
    function setLowSeason(seasons) {
        ...
        table_head_low += "<th class=\"text-center\"><a href=\"javascript:void(0);\" style=\"font-size:25px;\" id=\"addPeriodForLow\" title=\"Add More Seasons\"><span class=\"zmdi zmdi-plus\"></span></a></th></tr>";
        ...
        $('#addPeriodForLow').on('click', function() {
            ...
            if (data.find("input").attr("id") != 0) {
                ...
                rows_low_ += "<td><a  href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
                rows_low_ += "</tr>";
