...
<div class="card p-0">
        ...
        <div class="container p-0">
            ...
            <div class="row m-0">
                <div class="col-md-12 pt-3">
                    ...
                    <!--                  <hr/>-->
                    <div class="graph">
                        <canvas id="accomodation-chart" width="600" height="200 "></canvas>
                    </div>
                </div>
    ...
    <div class="c-footer">
        <small class="ml-4 mt-2 mr-2">Booked Room type Report: <label id="footerReport1"></label><label id="footerReport2"></label></small>
        <a class="pull-right mr-4 mt-1" hidden="hidden"><i class="fa fa-print"></i> print report</a>
        <a class="pull-right mr-4 mt-1" id="savepdf_accomodation"><i class="fa fa-file-pdf-o"></i> Export report to PDF</a>
...
<script>
    ...
    var timelabels = [];
    //    chart
    var ctxaccomodations = $("#accomodation-chart").get(0);
    ...
    var canvasr = document.getElementById('accomodation-chart');
    $('#savepdf_accomodation').click(function() {
        ...
        pdf.text(70, 15, 'ACCOMODATIONS REPORT');
        ...
        pdf.save("accomodations report.pdf");
    ...
    function setAccomodations(data) {
    ...
    function graphs(accomodations, label) {
        var accomodationsChart = new Chart(ctxaccomodations, {
            type: 'bar',
            data: {
                labels: label,
                datasets: [{
