...
<div class="card p-0">
    <div class="header p-3">
        <div class="row">
            <div class="col-md-3">
                Extras services booked by guests
            </div>
            ...
            <div class="row m-0">
                <div class="col-md-12 pt-3">
                    ...
                    <h3 class="text-light">
                        ...
                        <b><label class="pull-right" id="propertyname"></label></b><br><label id="fromTodate"> 2017 </label><br><label id="periodOfTime" class="pull-right"></label></small></h3>
                    <!--                  <hr/>-->
                    <div class="graph">
                        <canvas id="extras-chart" width="600" height="200 "></canvas>
                    </div>
                </div>
    ...
    <div class="c-footer">
        ...
        <a class="pull-right mr-4 mt-1" id="savepdf_extras"><i class="fa fa-file-pdf-o"></i> Export report to PDF</a>
...
<script>
    ...
    var timelabels = [];
    //    chart
    var ctxextras = $("#extras-chart").get(0);
    ...
    var canvasr = document.getElementById('extras-chart');
    $('#savepdf_extras').click(function() {
        ...
        pdf.text(60, 15, 'EXTRA SERVICES BOOKED REPORT');
        ...
        pdf.save("Extras services booked report.pdf");
