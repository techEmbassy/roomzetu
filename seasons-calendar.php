            ...
            <div class="row">
                <div class="col-md-2 mt-2">
                    ...
                    <!-- <div class="foot pt-4 pl-2 text-left ">
                        <a class="btn btn-sm btn-secondary" data-target="#change-season" data-toggle="modal"><i class="zmdi zmdi-plus"></i> New Season</a>
                    </div> -->
                        ...
                        <div class="header p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-right">
                                    ...
                                    <!--<a class="btn btn-secondary btn-35" href="" data-target="#new-px" data-toggle="modal"><i class="zmdi zmdi-plus"></i> New Season</a>-->
...
<a>23rd Nov - 14th June</a>-->
                                        ...
                                        <table class="table table-hover table-bordered text-wrap card-table small-text" id="tb_high">
                                            <!-- <tr class="tr-header">
                                                ...
                                                <th><a href="javascript:void(0);" style="font-size:18px;" id="addPeriodForHigh" title="Add More Seasons"><span class="zmdi zmdi-plus"></span></a></th>
                                                </tr>
                                                <tr style="background-color:#fafafa">
                                                    ...
                                                    <td><a href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>
                                                </tr>-->
                                        </table>
...
-->
                                        ...
                                        <table class="table table-hover table-bordered text-wrap card-table small-text" id="tb_low">
                                            <!-- <tr class="tr-header">
                                                ...
                                                <th><a href="javascript:void(0);" style="font-size:18px;" id="addPeriodForLow" title="Add More Seasons"><span class="zmdi zmdi-plus"></span></a></th>
                                                <!--</tr>-->
                                            <!--<tr style="background-color:#fafafa">
                                                    <td>
                                                        <label>1</label>
...
<script>
    ...
    function updateStartDate(t) {
        ...
        if (yyyy != yyyy_) {
            alertify.error("<i class='zmdi zmdi-check'></i> You can only select dates in the current year");
            getSeasons();
        } else {
    ...
    function update_season(id, date, period) {
        ...
        if (!(date.isNaN || date == "")) {
            $.post("src/xhr.php", {
                ...
                //alert(data);
                alertify.success("<i class='zmdi zmdi-check-circle'></i> Season updated");
                getSeasons();
            });
        }
    ...
    function setHighSeason(seasons) {
        ...
        table_head_high += "<th class=\"text-center\"><a href=\"javascript:void(0);\" style=\"font-size:25px;color:#1A6310;\" id=\"addPeriodForHigh\" title=\"Add More Seasons\"><span class=\"zmdi zmdi-plus\"></span></a></th></tr>";
        ...
        if (seasons.high.length != 0) {
            ...
            $.each(seasons.high, function(i, p) {
                ...
                rows_high += "<td class=\"text-center\"><a  id=\"" + p.id + "\" href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
                rows_high += "</tr>";
            ...
            rows_high += "<td class=\"text-center\"><a  href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
            rows_high += "</tr>";
        ...
        $('#addPeriodForHigh').on('click', function() {
            ...
            if (data.find("input").attr("id") != 0) {
                ...
                rows_high_ += "<td class=\"text-center\"><a  href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
                rows_high_ += "</tr>";
    ...
    function setLowSeason(seasons) {
        ...
        table_head_low += "<th class=\"text-center\"><a href=\"javascript:void(0);\" style=\"font-size:25px;color:#1A6310;\" id=\"addPeriodForLow\" title=\"Add More Seasons\"><span class=\"zmdi zmdi-plus\"></span></a></th></tr>";
        ...
        if (seasons.low.length != 0) {
            ...
            $.each(seasons.low, function(i, p) {
                ...
                rows_low += "<td class=\"text-center\"><a id=\"" + p.id + "\" href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
                rows_low += "</tr>";
            ...
            rows_low += "<td class=\"text-center\"><a href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
            rows_low += "</tr>";
        ...
        $('#addPeriodForLow').on('click', function() {
            ...
            if (data.find("input").attr("id") != 0) {
                ...
                rows_low_ += "<td class=\"text-center\"><a  href='javascript:void(0);' class='remove'><span class='zmdi zmdi-close'></span></a></td>";
                rows_low_ += "</tr>";
